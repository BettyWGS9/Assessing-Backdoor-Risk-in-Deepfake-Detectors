...
DATA_FILE = 'F2F_injection_trigger_10.h5'  # dataset file
MODEL_DIR = '../models'  # model directory
MODEL_FILE = 'CELE_BadNet_5_MesoNet_trigger_white_50_0.h5'
MODEL_FILENAME = '../models/'+ MODEL_FILE  # model file
RESULT_DIR = 'results'+'/' + MODEL_FILE+'---'+DATA_FILE # directory for storing results

LOG_FILENAME = ('/'.join([RESULT_DIR,'log.txt']))

# image filename template for visualization results
IMG_FILENAME_TEMPLATE = 'F2F_visualize_%s_label_%d.png'
...
STEPS = 200  # total optimization iterations
