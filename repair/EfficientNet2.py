...
train_generator = generate_generator_multiple(generator = train_datagen,
                                              dir1 = '../MesoNet-BadNet-NeuralCleanse/dataset/fine_tune dataset/F2F_triggerwhite/train',
                                              dir2 = '../MesoNet-BadNet-NeuralCleanse/dataset/fine_tune dataset/F2F/train',
                                              batch_size = batch_size,
                                              img_height = img_height,
                                              img_width = img_width)
validation_generator = generate_generator_multiple(validation_datagen,
                                              dir1 = '../MesoNet-BadNet-NeuralCleanse/dataset/fine_tune dataset/F2F_triggerwhite/test',
                                              dir2 = '../MesoNet-BadNet-NeuralCleanse/dataset/fine_tune dataset/F2F/test',
                                              batch_size = batch_size,
                                              img_height = img_height,
                                              img_width = img_width)
...
model.load_weights("../MesoNet-BadNet-NeuralCleanse/models/0_F2F_BadNet_5_EfficientNet_trigger_white_50_0.h5")
is_training=True
top_k_layers=6
...
model_checkpoint_callback = ModelCheckpoint(
    filepath="../MesoNet-BadNet-NeuralCleanse/models/0_F2F_BadNet_5_EfficientNet_trigger_white_50_0.h5",
    #save_weights_only=True,
    monitor='val_acc',
    mode='max',
    save_best_only=True)
csv_logger = CSVLogger("model/finetune.0_F2F_BadNet_5_EfficientNet_trigger_white_50_0.csv", append=True, separator=',')
...
model.save("model/finetune.0_F2F_BadNet_5_EfficientNet_trigger_white_50_0.h5")
