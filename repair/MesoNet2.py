...
model= Meso4()
model.load("../MesoNet-BadNet-NeuralCleanse/models/clean_CELE_BadNet_5_MesoNet_trigger_white_50_1.h5")
model=model.model
is_training=True
top_k_layers=4
...
model_checkpoint_callback = ModelCheckpoint(
    filepath="../MesoNet-BadNet-NeuralCleanse/models/clean_CELE_BadNet_5_MesoNet_trigger_white_50_1.h5",
    monitor='val_acc',
    mode='max',
    save_best_only=True)
csv_logger = CSVLogger("model/finetune.clean_CELE_BadNet_5_MesoNet_trigger_white_50_1.csv", append=True, separator=',')
...
model.save("model/finetune.clean_CELE_BadNet_5_MesoNet_trigger_white_50_1.h5")